...
class OutlineConverter:
    ...
    def to_full_text(outline: Union['BasicOutline', 'ArticleOutline', Dict[str, Any]]) -> str:
        ...
        # 获取大纲标题
        title = outline.title if hasattr(outline, 'title') else outline.get('title', '无标题')
        ...
        # 获取摘要
        summary = outline.summary if hasattr(outline, 'summary') else outline.get('summary', '')
    ...
    def to_basic_article(outline: Union['BasicOutline', 'ArticleOutline', Dict[str, Any]]) -> 'BasicArticle':
        ...
        # 获取ID
        outline_id = outline.id if hasattr(outline, 'id') else outline.get('id')
