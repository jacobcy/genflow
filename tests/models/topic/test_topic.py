...
class TestTopicBasics:
    ...
    def test_create_topic(self):
        ...
        topic = Topic(
            ...
            mobile_url="https://m.example.com/topics/test",
            hot=100,
            cover="https://example.com/images/test.jpg"
        )
        ...
        assert topic.platform == "medium"
        assert topic.url == "https://example.com/topics/test"
        assert topic.mobile_url == "https://m.example.com/topics/test"
        assert topic.hot == 100
        assert topic.cover == "https://example.com/images/test.jpg"
